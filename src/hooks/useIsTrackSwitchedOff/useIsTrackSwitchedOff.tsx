...
import { LocalVideoTrack, RemoteVideoTrack, RemoteDataTrack } from 'twilio-video';

type TrackType = RemoteVideoTrack | RemoteDataTrack | LocalVideoTrack | undefined | null;
