...
const statsHooks = __importStar(require("./useStatsUtils"));
const useStats_1 = __importDefault(require("./useStats"));
jest.mock('./useStats');
const mockUseStats = useStats_1.default;
...
describe('the getAllStats function', () => {
    ...
    it('should return an object with stats arrays from local and remote audio and video tracks', () => {
        ...
        expect(statsHooks.getAllStats(data)).toEqual(result);
    });
});
describe('the getAllTracks function', () => {
    it('should return an array with stats from local and remote audio and video tracks', () => {
        ...
        expect(statsHooks.getAllTracks(data)).toEqual(result);
    });
});
describe('the getTrackData function', () => {
    it('should return an array with all tracks for a specific trackSid', () => {
        ...
        expect(statsHooks.getTrackData('mockTrackSid', data)).toEqual([
...
describe('the getTotalBandwidth function', () => {
    ...
    describe('when "kind" is "bytesReceived"', () => {
        it('should correctly return bandwidth', () => {
            expect(statsHooks.getTotalBandwidth('bytesReceived', stats, previousStats)).toEqual(304);
        });
        it('should correctly return bandwidth when bytesReceived is null', () => {
            ...
            expect(statsHooks.getTotalBandwidth('bytesReceived', modifiedStats, modifiedPreviousStats)).toEqual(0);
        });
        it("should correctly return bandwidth when previous track information doesn't exist", () => {
            ...
            expect(statsHooks.getTotalBandwidth('bytesReceived', stats, modifiedPreviousStats)).toEqual(0);
        });
        it('should correctly return bandwidth when bytesReceived decreases over time', () => {
            ...
            expect(statsHooks.getTotalBandwidth('bytesReceived', stats, modifiedPreviousStats)).toEqual(152);
        });
    });
    describe('when "kind" is "bytesSent"', () => {
        it('should correctly return bandwidth', () => {
            expect(statsHooks.getTotalBandwidth('bytesSent', stats, previousStats)).toEqual(624);
        });
    });
    it('should return null when "stats" is undefined', () => {
        expect(statsHooks.getTotalBandwidth('bytesSent', undefined, previousStats)).toEqual(null);
    });
