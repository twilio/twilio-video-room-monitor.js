...
export declare function getActiveTrackData(previousStats: StatsReport[], stats: StatsReport[], trackSid: string): (import("twilio-video").LocalAudioTrackStats | import("twilio-video").LocalVideoTrackStats | import("twilio-video").RemoteAudioTrackStats | import("twilio-video").RemoteVideoTrackStats)[];
