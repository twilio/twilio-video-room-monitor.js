...
function useMediaStreamTrackProperties(mediaStreamTrack) {
    const [muted, setMuted] = react_1.useState(mediaStreamTrack === null || mediaStreamTrack === void 0 ? void 0 : mediaStreamTrack.muted);
    const [readyState, setReadyState] = react_1.useState(mediaStreamTrack === null || mediaStreamTrack === void 0 ? void 0 : mediaStreamTrack.readyState);
    react_1.useEffect(() => {
