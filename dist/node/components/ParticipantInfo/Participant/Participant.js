...
const Participant = ({ participant, isLocal }) => {
    const networkQualityLevel = useParticipantNetworkQualityLevel_1.default(participant);
    const isReconnecting = useParticipantIsReconnecting_1.default(participant);
    const publications = usePublications_1.default(participant, isLocal);
