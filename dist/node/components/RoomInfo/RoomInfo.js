...
function RoomInfo() {
    ...
    const dominantSpeaker = useDominantSpeaker_1.default();
    const roomState = useRoomState_1.default();
    const isRecording = useIsRecording_1.default();
    const { currentReceivedBitrate, currentSentBitrate } = useStats_1.default();
    if (!room)
        return null;
