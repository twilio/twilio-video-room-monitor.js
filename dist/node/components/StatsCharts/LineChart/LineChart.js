...
const theme = xychart_1.buildChartTheme({
...
function LineChart({ data, title, yAxisLabel }) {
    ...
    const xDomainMin = Math.min((_a = d3_array_1.min(data, (d) => d.x)) !== null && _a !== void 0 ? _a : 0, minTime);
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(xychart_1.XYChart, { height: 275, width: 465, xScale: {
                type: 'time',
                domain: [xDomainMin, (_b = d3_array_1.max(data, (d) => d.x)) !== null && _b !== void 0 ? _b : 0],
            }, yScale: {
                type: 'linear',
                domain: [0, Math.max(50, d3_array_1.max(data, (d) => d.y))],
